...
from healing.healing_review import (
    decision_defer,
    decision_heal,
...
from healing.paths import FAILURES_DIR, QUEUE_PATCHES
from healing.pom_apply import load_patch
from healing.review_display import (
    SKIP_REASONS,
    format_menu,
    format_review_card,
    format_skip_menu,
...
def run_interactive_review(
    ...
    *,
    ...
    if not remaining:
        ...
        out.write(".\n")
        out.write("Resume anytime: python -m healing.healing_review --interactive\n")
    out.write("\n")
    return 0
