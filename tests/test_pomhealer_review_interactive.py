...
from pomhealer.queue import mark_failure_proposed, mark_patch_ready, register_failure
from pomhealer.paths import configure_workspace, ensure_queue_dirs, FAILURES_DIR, QUEUE_PATCHES
from pomhealer.review_display import format_patch_list, format_review_card, format_menu
...
def test_format_review_card_includes_screenshot(tmp_path: Path, monkeypatch):
    ...
    shot = tmp_path / "pomhealer-artifacts" / "failures" / f"screenshot-{failure_id}.png"
