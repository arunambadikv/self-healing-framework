...
NAV_TIMEOUT_MS = _env_ms("POMHEALER_NAV_TIMEOUT_MS", 45_000)
# Action timeout for fill/click; keep moderate so intentional broken locators fail promptly.
ACTION_TIMEOUT_MS = _env_ms("POMHEALER_ACTION_TIMEOUT_MS", 8_000)
# How long to wait for a "page ready" locator after goto.
READY_TIMEOUT_MS = _env_ms("POMHEALER_READY_TIMEOUT_MS", 30_000)
# Retries for transient net::ERR_* during goto.
NAV_RETRIES = _env_ms("POMHEALER_NAV_RETRIES", 3)
