"""Optional BasePage mixin shipped with the pomhealer package for step tracing."""
...
from pomhealer.playwright_trace import suppress_auto_trace
from pomhealer.step_trace import record_step
from pomhealer.timeouts import (
    ACTION_TIMEOUT_MS,
    NAV_RETRIES,
    NAV_TIMEOUT_MS,
    READY_TIMEOUT_MS,
...
class BasePage:
    ...
    of Playwright Locator/Page (see ``pomhealer.playwright_trace``) is suppressed around
